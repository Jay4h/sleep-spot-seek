...
const DEFAULT_BEHIND_GRADIENT =
  'radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(188,95%,45%,var(--card-opacity)) 4%,hsla(188,50%,40%,calc(var(--card-opacity)*0.75)) 10%,hsla(188,25%,35%,calc(var(--card-opacity)*0.5)) 50%,hsla(188,0%,30%,0) 100%)';

const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg,hsl(188 95% 15%) 0%,hsl(188 80% 25%) 100%)';
